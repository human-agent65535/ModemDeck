...
func TestMobileAPIAllowsAuthenticatedApplicationSurface(t *testing.T) {
	...
	allowed := []struct {
		...
		{http.MethodPost, "/api/v1/calls/call-1/answer"},
		{http.MethodPost, "/api/v1/calls/call-1/reject"},
		{http.MethodPost, "/api/v1/calls/call-1/hangup"},
		{http.MethodPost, "/api/v1/calls/call-1/dtmf"},
		...
		{http.MethodPost, "/api/v1/mobile/push/test-call"},
